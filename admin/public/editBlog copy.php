                                ...
                                <div class="card-body">
                                    <form style='color:black;' id="editblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input class="form-control" name="main_image" type="file" id="formFileMainImage">
                                            <?php if (!empty($main_image)) { ?>
                                                <p class="mt-2">Current Image: <img src="uploads/photos/<?php echo $main_image; ?>" width="100"></p>
                                            <?php } ?>
                                        </div>

                                        <!-- Additional Images Upload -->
                                        <div class="mb-3">
                                            <label for="formFileExtraImages" class="form-label text-primary my-2">Upload logo</label>
                                            <input class="form-control" name="extra_images[]" type="file" id="formFileExtraImages" multiple>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <?php if (!empty($video)) { ?>
                                                <p class="mt-2">Current Video: <a href="uploads/videos/<?php echo $video; ?>" target="_blank">View Video</a></p>
                                            <?php } ?>
                                        </div>

                                        <!-- Blog Link -->
                                        <div class="mb-3">
                                            <label for="blogLink" class="form-label text-primary">External Blog Link (Optional)</label>
                                            <input type="url" class="form-control" name="blog_link" id="blogLink" value="<?php echo htmlspecialchars($blog_link ?? ''); ?>" placeholder="https://example.com">
                                        </div>
