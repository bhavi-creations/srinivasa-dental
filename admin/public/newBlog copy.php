                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    <form style='color:black;' id="addblogform" action="addBlog.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label for="formFileExtraImage" class="form-label text-primary">Choose  Logo</label>
                                            <input class="form-control" name="extra_image" type="file" id="formFileExtraImage">
                                        </div>

                                        <div class="mb-3">
                                            <label for="imageLink" class="form-label text-primary">Enter Redirect Link for Logo</label>
                                            <input type="url" class="form-control text-grey-900" name="image_link" id="imageLink" placeholder="https://example.com">
                                        </div>
