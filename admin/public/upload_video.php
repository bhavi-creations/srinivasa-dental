            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">UPLOAD VIDEO TESTIMONIAL</h1>
                    </div>
                        ...
                        <div class="col-xl-11">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-bold text-success">VIDEO UPLOAD</h6>
                                </div>
                                ...
                                <div class="card-body">
                                    <form style="color:black;" id="uploadvideoform" action="save_video.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3">
                                            <label class="form-label text-primary">Upload Video</label>
                                            <input class="form-control" name="video" type="file" accept="video/*" required>
                                        </div>
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <p style="color:black">©2024 Srinivasa Dental. All Rights Reserved. Designed & Developed by 
                        <a href="https://bhavicreations.com/" target="_blank" style="text-decoration:none;color:black">Bhavi Creations</a></p>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
