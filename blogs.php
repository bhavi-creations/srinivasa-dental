                        ...
                        <div class="grid row">
                            ...
                            if ($result->num_rows > 0) {
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    <div class='grid-item col-sm-12  col-lg-4 mb-5 card_bg_div_box'>
                                        <div class='post-box'>
                                            <figure>
                                            ...
                                            <div class='box-content'>
                                                <h5 class='box-title'><a  class='box-title' href='fullblog.php?id={$row['id']}'>" . substr(strip_tags($row['title']), 0, 50) . "...</a></h5>
