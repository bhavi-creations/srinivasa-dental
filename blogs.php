            ...
            <div class="col-md-4 mb-4">
              <div class="card">
                <?php
                  ...
                  $image_url = 'https://placehold.co/200x120?text=Srinivasa+Dental';
                  if(!isset($photos['0'])){
                    $image_url = 'admin/public/uploads/photos/'.$photos['0'];
                  }
                ?>
                ...
                <div class="card-body">
                  ...
                  <button class="btn ps-0 text-decoration-underline">Read More</button>
                </div>
              </div>
            </div>
          <?php
