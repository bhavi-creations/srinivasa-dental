            ...
            <ul class="dropdown-menu services_drop_menu mt-3" aria-labelledby="servicesDropdown" style="width:700px;">
              <div class="row  ">
                <div class="col-md-4">
                  ...
                  <li><a class="dropdown-item services_drop active_service" href="bridgetreatment.php">Crown & Bridge</a></li>
                </div>
                <div class="col-md-4">
          ...
          <div class="col-md-7 dr_content_padding   ">
            <h5 class="poetsen_font11">Tooth crowns and bridges are restorative dental solutions used to restore damaged teeth and replace missing ones, improving both function and appearance.
              ...
              <p class="poetsen_font1">
                Tooth crowns and bridges are effective restorative dental treatments designed to enhance the function and appearance of damaged or missing teeth. A crown is a cap placed over a damaged tooth to restore its shape, size, and strength, while a bridge consists of one or more artificial teeth anchored by crowns on adjacent teeth to fill gaps left by missing teeth. Crowns and bridges are custom-made to match the color and shape of natural teeth, providing a seamless and aesthetically pleasing result. The procedure involves shaping the existing tooth or teeth, taking impressions, and placing temporary restorations until the permanent ones are ready. With proper care, crowns and bridges can last for many years, offering a durable solution to common dental issues. Crowns and bridges are often 

              </p>

              <div class="showthisdiv  " style="display:none ">
                <p class="poetsen_font1">crafted from durable materials such as porcelain, ceramic, or metal, ensuring both strength and a natural appearance. The process typically begins with a thorough examination and preparation of the affected teeth, followed by the creation of detailed impressions to ensure a precise fit. Modern advancements in dental technology, such as digital scanning, have streamlined the fitting process, leading to more accurate and comfortable restorations. While crowns and bridges can significantly improve oral function and aesthetics, maintaining good oral hygiene and regular dental check-ups are crucial for their longevity and overall oral health. This approach helps prevent issues such as decay around the crown or bridge and ensures that the surrounding teeth remain healthy.</p>
              </div>
