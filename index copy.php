                    ...
                    <div class="accordion">
                        ...
                        <div class="faq_section">
                            ...
                            <div class="accordion-content">
                                ...
                                <p>
                                    Cleaning does not create gaps. The gaps you notice were already present but hidden under deposits. Cleaning actually improves gum health and prevents tooth loosening.
                                </p>

                                <p>
                                    <a href="https://srinivasadentalkakinada.com/">If your gums bleed or teeth feel dirty, a professional cleaning can help. Visit our Kakinada clinic</a>
                                </p>

                                <strong> Teeth cleaning cost: ₹1,000–₹2,500 </strong>
                            </div>
                        </div>
                        ...
                        <div class="faq_section">
                            <div class="accordion-header" onclick="toggleAccordion(this)">
                                <h2 class="faq_heading_section">Why do my gums bleed while brushing?
                            ...
                            <div class="accordion-content">
                                <p>
                                    Bleeding gums are usually a sign of gum infection or plaque buildup. It is not normal and should not be ignored.
                                </p>

                                <p>
                                    Early gum treatment and professional cleaning can reverse the condition. Delaying may lead to gum disease and tooth loosening.
                                </p>

                                <p>
                                    If your gums bleed, get them checked early at <a href="https://srinivasadentalkakinada.com/">our Kakinada clinic.</a>
                                </p>
                            </div>
                        </div>
                        ...
                        <div class="faq_section">
                            <div class="accordion-header" onclick="toggleAccordion(this)">
                                <h2 class="faq_heading_section"> What is the difference between filling and crown?
                            ...
                            <div class="accordion-content">
                                <p>
                                    A filling is used when the tooth damage is small, like a minor cavity. A crown (cap) is needed when the tooth is weak, broken, or has undergone root canal treatment.
                                </p>
                                <p>
                                    Fillings repair a part of the tooth, while crowns cover and protect the entire tooth, making it stronger and long-lasting.

                                </p>
                                <p>
                                    Not sure what your tooth needs? Visit our Kakinada clinic for an evaluation.
                                </p>
                                <p><strong>Fillings: ₹800–₹3,000 | Crowns: ₹3,500–₹15,000</strong></p>
                            </div>
                        </div>
              ...
              <div class="accordion-content">
                ...
                <div class="col-12 col-md-6">
                    ...
                    <div class="accordion">
                        ...
                        <div class="faq_section">
                            <div class="accordion-header" onclick="toggleAccordion(this)">
                                <h2 class="faq_heading_section">Can bad breath be treated permanently?
                            ...
                            <div class="accordion-content">
                                <p>
                                    Yes. Bad breath is often caused by gum disease, cavities, or tongue deposits. Treating the cause—not masking it—can permanently solve the issue.
                                </p>

                                <strong>
                                    Treatment depends on cause; basic care starts from ₹1,000.
                                </strong>
                            </div>
                        </div>
                        <!-- Accordion 2 -->
                        <div class="faq_section">
                            ...
                            <div class="accordion-header" onclick="toggleAccordion(this)">
                                <h2 class="faq_heading_section">Zirconia vs Metal Ceramic Crowns – Which Is Right for You?
                            ...
                            <div class="accordion-content">
                                <p>
                                    Zirconia crowns are metal-free, strong, and look very natural. Metal ceramic crowns are durable and more affordable but may show a dark line near gums over time.
                                </p>
                                <p>We help patients choose based on tooth position, budget, and esthetic needs.
                                </p>
                                <p>Consult us in Kakinada to choose the right crown for your tooth.</p>

                                <strong>Zirconia: ₹10,000–₹15,000 | Metal ceramic: ₹4,000–₹7,000</strong>
                            </div>
                        </div>
                        ...
                        <div class="faq_section">
                            <div class="accordion-header" onclick="toggleAccordion(this)">
                                <h2 class="faq_heading_section"> Can broken teeth be saved?
                            ...
                            <div class="accordion-content">
                                <p>
                                    Yes, in most cases broken teeth can be saved using fillings, crowns, or root canal treatment, depending on the damage.
                                </p>
                                <p>Early treatment increases the chances of saving the natural tooth.</p>
                                <p>If you have a broken tooth, get it checked early at our Kakinada clinic.
                                    Create insta reels riot with Telugu and English mix</p>
                            </div>
                        </div>
                        <!-- Accordion 4 -->
                        <div class="faq_section">
                            <div class="accordion-header" onclick="toggleAccordion(this)">
                                <h2 class="faq_heading_section"> What is the best age to get braces?
                            ...
                            <div class="accordion-content">
                                <p>
                                    The ideal age for braces is 10–14 years, when jaw growth is active. However, adults can also get braces successfully at any age. </p>
                                <P>We evaluate each patient individually.</P>
                                <P> Bring your child or yourself for an orthodontic evaluation in Kakinada</P>
                            </div>
                        </div>
                        <!-- Accordion 5 -->
                        <!-- <div class="faq_section">
