       ...
       <div class="container" data-aos="fade-up">
         ...
         <div class="row">
           ...
           <div class="col-12 col-md-8  col-lg-7   content_padding" data-aos="fade-left">
             ...
             <p class=poetsen_font>
               ur dental team, led by Dr. Kiran Raju, is dedicated to making our practice patient-centered. We want each patient to feel like a member of the Srinivasa Dentistry family, confidently putting their trust in our team. check our testimonials to see why we are passionate about our patients’ experience. <br><br>
               We will help you choose a custom care plan designed to help you accomplish the smile of your dreams find more about dentist in kakinada at our What Patients Say Section
             </p>
             ...
             <div class="row">
               <div class="col-6">
                 ...
                 <p class="tetx_color_about"><i class=" check_mark fa-solid fa-circle-check "></i> Modern Equipment </p>
                 <p class="tetx_color_about"><i class=" check_mark fa-solid fa-circle-check "></i> Comfortable CIinic</p>

               </div>

               <div class="col-6">

                 <p class="tetx_color_about"><i class=" check_mark fa-solid fa-circle-check "></i> Always Monitored </p>
                 <p class="tetx_color_about"><i class=" check_mark fa-solid fa-circle-check "></i> Online Appointment</p>
     ...
     <section>
       <div class="container">
         <div class="section-title text-center">
           ...
           <p class="  text-center service_text">General & Cosmetic Dentistry can give you a smile you’re happy to show off. Modern cosmetic dentistry techniques make it easier than ever for you to have a bright, even smile. Srinivasa dentist in kakinada
     ...
     <section>
       <div class="container">
         <div class="section-title text-center">
           ...
           <p class="  text-center service_text">We use only the best quality materials on the market in order to provide the best products to our patients.
           </p>
