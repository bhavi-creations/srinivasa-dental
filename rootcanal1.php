...
<head>
    ...
    <style>
        .background-section {
            background-image: url('assets/img/services/rootcanal-1.png');
            ...
            position: relative;
            /* Keeps children positioned relative to this section */
            padding-left: 5%;
            /* Adds some padding to keep the content away from the extreme left */
            box-sizing: border-box;
            /* Ensures padding is included in dimensions */
        }

        /* Content Styling */
        .content {
            position: relative;
            /* Positions content within the section */
            color: #1d2053;
            /* Sets text color */
            text-align: left;
        ...
        @media (max-width: 768px) {
            .background-section {
                padding-left: 2%;
                /* Adjusts left padding for smaller screens */
            }

            .content {
                max-width: 250px;
                /* Restricts content width on small screens */
            }
        ...
        @media (min-width: 1600px) {
            ...
            .background-section {height: 82vh;}
                ...
                <ul>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu services_drop_menu mt-1" aria-labelledby="servicesDropdown" style="width:700px;">
                            <div class="row  ">
                                <div class="col-md-4">
                                    <li><a class="dropdown-item services_drop active_service" href="rootcanal.php">Root Canal</a></li>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="service_contain_text">
                        ...
                        <p>
                            A root canal involves <a href="services.php"> removing infected or damaged pulp </a> from the tooth. The dentist makes an opening in the tooth to access and clean the pulp chamber. After cleaning, the chamber is filled with a sealing material to prevent further infection. The tooth is then restored with a filling or crown for strength and protection. </p>
                        </p>
                    </div>
                </div>
            </div>
        ...
        <section>
            <div class="container">
                <div class="section-title text-center">
                    ...
                    <h2 class="apporach">Watch the Root Canal Treatment </h2>
                    ...
                    <h2 class="apporach"> A Step-by-Step Guide to a Painless Procedure</h2>
                                ...
                                <div class="tile">
                                    <div class="tile__media">
                                        <div class="video-container">
                                            <iframe width="560" height="315" src="https://www.youtube.com/embed/xpH8UnortD4?si=hnA2hRzJ6_WP8v32" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
                                        </div>
                                    </div>
                                </div>
                            </div>
