...
<head>
  ...
  <style>
    ...
    *::after {
    ...
    .index_new_doctor_img_wrap:hover img {
    ...
    .index_new_doctor_heading {
      font-family: 'glida display', serif;
      /* font-family: 'Playfair Display', serif; */
    ...
    .index_new_doctor_btn_primary i {
      font-size: 12px;
    }
    ...
    .index_new_doctor_btn_outline i {
      font-size: 12px;
    }
