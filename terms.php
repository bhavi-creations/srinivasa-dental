      ...
      <div class="container">
        <div class="row">
          ...
          <ul>
            ...
            <li>
              <p>
                <strong>Website</strong> refers to srinivasadentalkakinada,
                accessible from
                <a
                  href="https://srinivasadentalkakinada.com/"
                  rel="external nofollow noopener"
                  target="_blank">https://srinivasadentalkakinada.com/</a>
              </p>
            </li>
            <li>
              <p>
          ...
          <ul>
            ...
            <li>
              <p>
                ...
                <a
                  href="https://srinivasadentalkakinada.com/contact-us/"
                  rel="external nofollow noopener"
                  target="_blank">https://srinivasadentalkakinada.com/contact-us/</a>
              </p>
            </li>
            <li>
