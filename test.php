...
<?php include 'navbar.php'; ?>
    ...
    <main id="main">
        ...
        <img src="assets/img/services/sub-services/rootcanal-1.png" alt="" class="img-fluid">
            ...
            <div class="container">
                ...
                <div class="row my-3">
                    <div class="col-12 col-md-4  card-wrapper ">
                        <div class="card">
                            <img src="assets/img/services/rootcanal2.png" alt="" class="img-fluid  card_img_border">
                    ...
                    <div class="col-12 col-md-4  card-wrapper">
                        <div class="card">
                            <img src="./assets/img/services/rootcanal3.png" alt="" class="img-fluid card_img_border">
                    ...
                    <div class="col-12 col-md-4  card-wrapper">
                        <div class="card">
                            <img src="./assets/img/services/rootcanal1.png" alt="" class="img-fluid card_img_border">
